%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% [AMI_, MI]=ami(true_mem,mem)
%
% Input arguments: true_mem, mem = Vectors of the same length
%
% Output arguments: AMI_ / MI = Adjusted mutual information
%
...
function [AMI_, MI]= ami(true_mem,mem)
if nargin==1
