...
%% Graphs
subplot(2,1,1);scatter(data(:,1),data(:,2),10,idsR,'filled');title('Original clusters');axis equal;
subplot(2,1,2);scatter(data(:,1),data(:,2),10,ids,'filled');title('Clusters found by k-means- euclidean distance');axis equal;
